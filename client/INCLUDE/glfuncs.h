...
struct glSurface
{
    ...
    void blitFast(int x,int y,float scalex=1.0f,float scaley=1.0f)
    {
        ...
        glVertex2d( x, y );
        glTexCoord2f(1,0);
        glVertex2d( x+w*scalex, y );
        glTexCoord2f(1,1);
        glVertex2d( x+w*scalex, y+h*scaley );
        glTexCoord2f(0,1);
        glVertex2d( x, y+h*scaley );
        glEnd();
    }
    ...
    void blit(int x,int y,int sx=0,int sy=0,int cw=0,int ch=0,double scalex=1.0f,double scaley=1.0f)
    {
        ...
        glVertex2d( x, y );
        glTexCoord2f(gx,fy);
        glVertex2d( x+int(float(cw)*scalex), y );
        glTexCoord2f(gx,gy);
        glVertex2d( x+int(float(cw)*scalex), y+int(float(ch)*scaley) );
        glTexCoord2f(fx,gy);
        glVertex2d( x, y+int(float(ch)*scaley) );
        glEnd();
    }
